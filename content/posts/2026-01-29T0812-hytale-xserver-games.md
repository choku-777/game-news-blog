---
title: "『Hytale』のサーバーが簡単に作れる！完全無料のマルチプレイサーバーを「XServer GAMEs」が提供開始"
date: 2026-01-29T08:12:14.000Z
tags: ["game-news"]
---
{{< chat >}}
...
「『Hytale』のサーバーが簡単に作れる！完全無料のマルチプレイサーバーを「XServer GAMEs」が提供開始」

複数サイト（1）で扱われてるから、重要度高め。

【事実ライン（複数ソース統合）】
- 【Game*Spark】エックスサーバーは、マルチプレイ専用ゲームサーバーサービス「XServer GAMEs」にて、サンドボックスRPG『Hytale』へ対応した完全無料サーバーの提供を開始した。
- ・各種設定もラクラク変更！
- ・本サービスは、『マインクラフト』や『7 Days to Die』など30種類以上のゲームのサーバーを提供するサービスで、今回は国内向けとして初めて『Hytale』に対応。{{< /msg >}}
...
---
出典/関連リンク：
- **Game*Spark**: http://www.gamespark.jp/article/2026/01/29/162136.html
